...
class KbordaLastFCFS(VotingRuleConstrained):
    """
    Class for K-Borda voting rule with the last question with budget distributed according to the first-come-first-serve
    principle
    ...
    def find_winners(election: Election, num_winners: int, question_limit: int) -> list[int]:
        """
        Returns a list of the winners of the election according to the K-Borda rule with the last question with budget
        distributed according to the first-come-first-serve principle
    ...
    def __str__():
        ...
        """
        return "K-Borda Last Questions distributed first come first serve"
